  ...
  return (
    <ContextMenu>
      <ContextMenuTrigger>
        ...
        <ContextMenuContent className="bg-[#1e1e1e] text-white ">
          <ContextMenuItem className="bg-[#1e1e1e] text-white p-2 mt-1 my-2 w-full">
            <Link target="_blank" to={`/compiler/${data._id}`}>
              Open In Editor
            </Link>
          </ContextMenuItem>
          <ContextMenuItem className="bg-[#1e1e1e] text-white p-2 mt-2 my-2 w-full">
            Edit
          </ContextMenuItem>
          <ContextMenuItem
            onClick={handleDeleteCode}
            className="bg-[#1e1e1e] text-white p-2 mt-2 my-2  w-full"
          >
            Delete
          </ContextMenuItem>
        </ContextMenuContent>
